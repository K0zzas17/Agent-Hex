...
class State:
    ...
    def get_successors(self):
        """
        :return: A dictonary of successor States
        """
        successors = []
        for a in ROBOT_ACTIONS:
            next_state = self.environment.perform_action(self, a)
            if next_state[0]:
                successors.append((next_state[2], next_state[1], a))
        return successors

    # def manhattan_distance_heurestic(self, env):
